    ...
    render() {
        ...
        return (
            <div className={styles.container}>
                ...
                <CSSTransition in={contacts.length >= 2} timeout={250} classNames={slideTransition} unmountOnExit>
                    <Section title="">
                ...
                <CSSTransition in={alert.isShow} timeout={250} classNames={slideTransition} unmountOnExit>
